package cn.com.bmsoft.modules.oauth2;
...
import cn.com.bmsoft.modules.sys.service.ShiroService;
...
public class OAuth2Realm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SysUserTokenEntity tokenEntity = sysUserTokenRedis.get(accessToken);
        if(tokenEntity == null){
        ...
        SysUserEntity user = sysUserRedis.get(tokenEntity.getUserId());
        if(user == null){
